...
export const Sidebar = ({ toggleOpen, sidebarIsOpen }) => {
  ...
  useEffect(() => {
    const handleResize = () => {
      const innerWidthWhenSidebarIsHidden = 500;
    ...
    return (
      <>
        <img
          ...
          alt="account"
        />
        <p className="Sidebar__account-name item--text">'Учитель'</p>
      </>
    );
  }, []);
    ...
    <div className="Sidebar-outer-wrapper">
      ...
      >
        ...
        <div className="Sidebar-wrapper">
          <div className="Sidebar__logo nav-link-reset" to="/">
            <img
            ...
            <div className="nav-link-reset">
              <li className="Sidebar__navigation-item item--wrapper item--hover">
                <img
                  ...
                  alt="play"
                />
                <p className="Sidebar__navigation-title item--text">Материалы</p>
              </li>
            </div>
            <div className="nav-link-reset">
              <li className="Sidebar__navigation-item item--wrapper item--hover">
                <img
                  ...
                  alt="tasks"
                />
                <p className="Sidebar__navigation-title item--text">Сообщества</p>
              </li>
            </div>
            <div className="nav-link-reset">
              <li className="Sidebar__navigation-item item--wrapper item--hover">
